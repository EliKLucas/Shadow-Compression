...
# --- Set Up Workspace ---
save_folder = 'frames_random'
os.makedirs(save_folder, exist_ok=True)

# --- Step 1: Simulate Base Random Graph ---
G_base = nx.erdos_renyi_graph(300, 0.05)  # 5% connection probability

print(f"Random Graph: {G_base.number_of_nodes()} nodes, {G_base.number_of_edges()} edges")
...
with imageio.get_writer('random_graph_melting.gif', mode='I', duration=0.3) as writer:
    for filename in frame_files:
        image = imageio.imread(filename)
        writer.append_data(image)

print("\n✅ Random graph melting animation saved as 'random_graph_melting.gif'!")
