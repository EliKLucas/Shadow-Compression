...
with imageio.get_writer('snowflake_melting.gif', mode='I', duration=0.3) as writer:
    for filename in frame_files:
        image = imageio.imread(filename)
        writer.append_data(image)

print("\n✅ Animation saved as 'snowflake_melting.gif'!")
